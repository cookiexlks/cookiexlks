...
## 🛠 Tools and Languages
[![My Skills](https://skillicons.dev/icons?i=html,cpp,js,windows,matlab,java,css,python,pycharm,flask,go,bash,rust,r,astro)](#)
...
- sometimes im eating cookies so i wont always be active but when im not eating cookies i will be active 👍
